...
const Reports = () => {
  ...
  const handlePrint = () => {
    ...
    const clientBreakdownRows = clientBreakdown.map(client => `
      <tr>
    ...
    printWindow.document.write(`
      ...
      <body>
        ...
        <h2 style="margin-bottom:15px;">Client Breakdown</h2>
        <table>
          <thead>
            <tr><th>Client</th><th>Total Loans</th><th>Total Borrowed (K)</th><th>Total Paid (K)</th><th>Outstanding (K)</th></tr>
          </thead>
          <tbody>
            ${clientBreakdownRows || '<tr><td colspan="5" style="text-align:center;padding:30px;color:#999">No data yet</td></tr>'}
          </tbody>
        </table>
