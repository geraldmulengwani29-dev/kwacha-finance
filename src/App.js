      ...
      if (currentUser) {
        ...
        try {
          ...
          if (clientDoc.exists()) {
            ...
            // Default to 'client' to prevent security/authorization bypass if Firestore document is missing
            setRole('client');
          }
        } catch (error) {
          // Log error internally and fail secure by defaulting to 'client'
